//lib/services/admin/profile_cloudinary_service.dart
import 'dart:io';
import 'dart:convert';
...
class CloudinaryService {
  ...
  // Method untuk upload gambar dengan unsigned upload preset (support custom preset dan folder)
  Future<String?> uploadImageUnsigned(
    File imageFile, {
    String uploadPreset = 'profile_pictures',
    String? folder,
  }) async {
    try {
      print('Starting image upload to Cloudinary...');
      
      // Cek konfigurasi uploadPreset minimal tidak kosong
      ...
      // Optional: simpan dalam folder yang ditentukan
      ...
      print('Sending request to Cloudinary with preset: $uploadPreset, folder: $folder');
